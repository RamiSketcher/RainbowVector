...
parser.add_argument('--evaluation-interval', type=int, default=500000, metavar='STEPS', help='Number of training steps between evaluations')
...
parser.add_argument('--checkpoint-interval', default=int(1e5), help='How often to checkpoint the model, defaults to 0 (never checkpoint)')
